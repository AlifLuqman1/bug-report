...
class Admin2Controller extends Controller
{
    ...
    {
        $data = BugReportApplication::with(['bugReportApplicationCategory', 'bugReportApplicationSubSection', 'bugReportApplicationSection', 'bugReportApplicationUnitAssign', 'bugReportApplicationStatus'])->where('status', '2')->orWhere('status', '3')->get();

        $checkedData = BugReportApplication::with(['bugReportApplicationCategory', 'bugReportApplicationSubSection', 'bugReportApplicationSection', 'bugReportApplicationUnitAssign', 'bugReportApplicationStatus'])->where('status', '4')->orWhere('status', '5')->orWhere('status', '8')->get();
        ...
        return view('bug-report.admin.indexadmin2', compact('data','checkedData','returnData'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $admin2_commented_at = Carbon::now();
        // $admin1_commented_at = date('Y-m-d H:i:s');
        $bugReportApplication->admin2_commented_at = $admin2_commented_at;
        $bugReportApplication->save();

        return redirect('/admin2notify')->with('success', 'Your comment successfully submitted!');
    }
    ...
    public function edit($id)
    {
        ...
        return view('bug-report.admin.createadmin2')->with([
    ...
    public function update(StoreBugReportApplication $request, $id)
    {
        ...
        return redirect('/admin2notify')->with('success', 'Your comment successfully updated!');
    }
