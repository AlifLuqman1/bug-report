    ...
    @section('content')
        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <div class="card card-custom text-lg-center"
                    ...
                    <div class="card-header" style="background:#040041">
                        ...
                        <div class="btn-group-vertical" role="group" aria-label="Vertical button group">
                            <div class="innercontent" style="display: flex">
                                ...
                                <a href="{{ url('/report/create') }}"
                                    style="margin-top:auto; margin-bottom:auto;"><button type="button"
                                        ...
                                        style="margin: 8px; border-radius: 8px; padding-left:15px; background:#040041"><i
                            ...
                            <div class="innercontent" style="display: flex">
                                ...
                                <p class=" text-lg-left"
                                    style="margin-top: auto; margin-bottom:auto; font-size:18px; margin-left:15px; margin-right:0px; width:200px">
                                    System Error</p>
                                <a href="{{ url('/report2/create') }}"
                                    style="margin-top:auto; margin-bottom:auto;"><button type="button"
                                        class="btn btn-primary"
                                        style="margin: 8px; border-radius: 8px; padding-left:15px; margin-top: auto; margin-bottom:auto; background:#040041"><i
                                            class="fas fa-arrow-right"></i></button></a>
                            </div>
                        </div>
                    </div>
        ...
        {{-- @if (count($items) > 0)
            @foreach ($items as $data)
                <div class="well"> --}}
                    {{-- <img style="width:100%" src='/storage/attachments/{{$data->attachment}}'> --}}
