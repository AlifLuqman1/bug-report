...
@section('content')
    <div class="row" style="margin:10px">
        <div class="card card-custom col-xs-12 col-md-12 col-sm-12 col-lg-12"
            ...
            <!--begin::Card-->
            <form action="/report2/create2" method="POST" enctype="multipart/form-data" class="form" id="form">
                @csrf
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6" style="padding-left: 15px">
                        ...
                        <input type="email" name="email" id="email" class="form-control" placeholder="abc123@gmail.com">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6" style="padding-right: 15px">
