<div class="card-body">
    ...
    <div class="form-group mb-1">
        <label for="unit_comment">Comment <span class="text-danger">*</span></label>
        <textarea type="text" class="form-control form-control-fvio @error('unit_comment') is-invalid @enderror"
            id="unit_comment" rows="7" name="unit_comment"
            value="{{ old('unit_comment') ?: (isset($bugReportApplication->unit_comment) ? $bugReportApplication->unit_comment : '') }}">{{ $bugReportApplication->unit_comment }}</textarea>
        <span style="color:red">@error('unit_comment'){{ $message }} @enderror</span>
    </div>
    <br>
